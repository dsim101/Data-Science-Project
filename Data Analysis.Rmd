...
cf$correct_white <- cf$number_of_hits_white + cf$number_of_cr_white
cf$correct_black <- cf$number_of_hits_black + cf$number_of_cr_black
cf$correct_latinx <- cf$number_of_hits_latinx + cf$number_of_cr_latinx
...
# White vs. Black
t.test(cf$correct_white,
       cf$correct_black,
       paired=TRUE,
       conf.level=0.95)

cohen.d(cf$correct_white,
        cf$correct_black,
        paired=TRUE,
        conf.level=0.95)
...
# Black vs. Latinx
t.test(cf$correct_black,
       cf$correct_latinx,
       paired=TRUE,
       conf.level=0.95)

cohen.d(cf$correct_black,
        cf$correct_latinx,
        paired=TRUE,
        conf.level=0.95)

describe(cf[,c("number_of_hits_white", "number_of_miss_white", "number_of_cr_white", "number_of_fa_white",
               "number_of_hits_black", "number_of_miss_black", "number_of_cr_black", "number_of_fa_black", "number_of_hits_latinx", "number_of_miss_latinx", "number_of_cr_latinx", "number_of_fa_latinx")])
...
cf$white_hits <- cf$number_of_hits_white/36
cf$white_cr <- cf$number_of_cr_white/36
cf$white_fa <- cf$number_of_fa_white/36
cf$white_miss <- cf$number_of_miss_white/36
cf$black_hits <- cf$number_of_hits_black/36
cf$black_cr <- cf$number_of_cr_black/36
cf$black_fa <- cf$number_of_fa_black/36
cf$black_miss <- cf$number_of_miss_black/36
cf$latinx_hits <- cf$number_of_hits_latinx/36
cf$latinx_cr <- cf$number_of_cr_latinx/36
cf$latinx_fa <- cf$number_of_fa_latinx/36
cf$latinx_miss <- cf$number_of_miss_latinx/36
